...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mac', models.CharField(default='', max_length=100, unique=True, verbose_name='设备mac地址')),
                ...
                ('last_login_time', models.DateTimeField(auto_now_add=True, verbose_name='设备最后上线时间')),
                ('last_logout_time', models.DateTimeField(auto_now_add=True, verbose_name='设备最后下线时间')),
                ...
                ('x_index', models.IntegerField(default=0, null=True, verbose_name='位置')),
                ('y_index', models.IntegerField(default=0, null=True, verbose_name='位置')),
